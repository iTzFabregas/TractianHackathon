import '../assets/styles.css'; // Ajuste o caminho conforme necessário

export default function Bololo() {

    return (
        <>
  <h1>Ordem de Procedimento para Lubrificação de Rolamentos 1</h1>
