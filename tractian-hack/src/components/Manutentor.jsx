...
export default function Manutentor() {
    ...
    const [items, setItems] = useState([
        ...
        { id: 2, text: 'Verifique se houve superaquecimento.', estado:'Crítico', check: `<h2>Checklist de Conformidade NR12 - Prevenção de Superaquecimento</h2>\n\n<h3>1. Proteção contra Queimaduras devido ao Contato com Superfícies Aquecidas (Seção 12.10.4):</h3>\n<ul>\n    <li>1.1. Redução da Temperatura de Superfície:\n        <ul>\n            <li>1.1.1. Verificar se a temperatura das superfícies das máquinas e equipamentos está abaixo do limite de queima para o material específico.</li>\n            <li>1.1.2. Confirmar a implementação de sistemas de resfriamento ou ventilação adequados para reduzir a temperatura.</li>\n        </ul>\n    </li>\n    <li>1.2. Isolamento com Materiais Apropriados:\n        <ul>\n            <li>1.2.1. Certificar-se de que as superfícies aquecidas estão isoladas com materiais resistentes ao calor e com propriedades isolantes adequadas.</li>\n            <li>1.2.2. Verificar se o material isolante está em boas condições, sem danos ou desgaste.</li>\n        </ul>\n    </li>\n    <li>1.3. Uso de Barreiras:\n        <ul>\n            <li>1.3.1. Instalar barreiras físicas quando a temperatura de superfície exceder o limite seguro para contato durante o período especificado.</li>\n            <li>1.3.2. Garantir que as barreiras estejam fixas corretamente e sem obstruções.</li>\n        </ul>\n    </li>\n</ul>\n\n<h3>2. Proteção contra Substâncias Perigosas (Seção 12.10.3):</h3>\n<ul>\n    <li>2.1. Emissão e Liberação:\n        <ul>\n            <li>2.1.1. Verificar a presença de medidas para prevenir a emissão e liberação de substâncias inflamáveis, explosivas ou perigosas.</li>\n            <li>2.1.2. Confirmar a existência de sistemas de contenção e ventilação para evitar a acumulação de substâncias perigosas.</li>\n        </ul>\n    </li>\n    <li>2.2. Combustão e Explosão:\n        <ul>\n            <li>2.2.1. Assegurar que os equipamentos possuam dispositivos de segurança para prevenir combustões e explosões.</li>\n            <li>2.2.2. Testar regularmente os dispositivos de segurança para garantir sua funcionalidade.</li>\n        </ul>\n    </li>\n    <li>2.3. Reações Acidentais:\n        <ul>\n            <li>2.3.1. Identificar e isolar fontes potenciais de ignição em áreas de risco.</li>\n            <li>2.3.2. Implementar procedimentos de emergência para reações acidentais.</li>\n        </ul>\n    </li>\n    <li>2.4. Ocorrência de Incêndios:\n        <ul>\n            <li>2.4.1. Instalar detectores de fumaça e sistemas de supressão de incêndio próximos a áreas de risco.</li>\n            <li>2.4.2. Realizar treinamentos regulares de evacuação e uso de extintores de incêndio com os colaboradores.</li>\n        </ul>\n    </li>\n</ul>\n\n<h3>3. Documentação e Manutenção:</h3>\n<ul>\n    <li>3.1. Manutenção Regular:\n        <ul>\n            <li>3.1.1. Estabelecer cronogramas de manutenção preventiva para sistemas de segurança e isolamento térmico.</li>\n            <li>3.1.2. Manter registros detalhados das inspeções e manutenções realizadas.</li>\n        </ul>\n    </li>\n    <li>3.2. Atualização de Documentação:\n        <ul>\n            <li>3.2.1. Garantir que toda a documentação de segurança e conformidade esteja atualizada e acessível aos responsáveis.</li>\n            <li>3.2.2. Revisar e atualizar procedimentos operacionais conforme necessário.</li>\n        </ul>\n    </li>\n</ul>\n\n<p>Este checklist detalhado auxilia na verificação da conformidade com as seções relevantes da NR12, garantindo a segurança contra queimaduras e a proteção contra substâncias perigosas em ambientes de trabalho.</p>`, passo_a_passo: `<h2><strong>Ordem de Procedimento para Verificação de Problemas de Superaquecimento</strong></h2>\n\n<h3><strong>Objetivo:</strong></h3>\n<p>Este procedimento visa orientar o técnico de manutenção na verificação e resolução de problemas relacionados ao superaquecimento de motores.</p>\n\n<h3><strong>Materiais e Equipamentos Necessários:</strong></h3>\n<ul>\n    <li>Serra Circular (MAT001)</li>\n    <li>Lixadeira Angular (EQP001)</li>\n    <li>Paquímetro Digital (MAT101)</li>\n    <li>Graxa Industrial (MAT301)</li>\n</ul>\n\n<h3><strong>Procedimento:</strong></h3>\n<ol>\n    <li><strong>Inspeção dos Dispositivos de Proteção Térmica:</strong>\n        <ul>\n            <li>Verifique o funcionamento dos termostatos e protetores térmicos, como Pt-100, KTY e termopares.</li>\n            <li>Certifique-se de que todos os dispositivos estão calibrados e operando dentro das especificações de fábrica.</li>\n        </ul>\n    </li>\n    <li><strong>Verificação dos Detectores de Temperatura por Resistência (RTD):</strong>\n        <ul>\n            <li>Realize testes para confirmar que os RTDs estão operando corretamente.</li>\n            <li>Utilize o Paquímetro Digital (MAT101) para medir e garantir a precisão das leituras de temperatura.</li>\n        </ul>\n    </li>\n    <li><strong>Avaliação do Motor para Sinais de Sobrecarga:</strong>\n        <ul>\n            <li>Inspecione visualmente o motor em busca de sinais de sobrecarga, como descoloração ou cheiro de queimado.</li>\n            <li>Verifique se todas as medidas de proteção contra sobrecarga estão ativas e funcionando.</li>\n        </ul>\n    </li>\n    <li><strong>Verificação da Pintura Anticorrosiva Interna do Motor:</strong>\n        <ul>\n            <li>Inspecione a pintura interna do motor, especialmente em ambientes de alta umidade, para detectar sinais de corrosão.</li>\n            <li>Caso necessário, utilize a Lixadeira Angular (EQP001) para remover áreas corroídas e aplique nova camada de Graxa Industrial (MAT301) para proteção.</li>\n        </ul>\n    </li>\n    <li><strong>Verificação de Operação Dentro das Variações de Tensão e Frequência Especificadas:</strong>\n        <ul>\n            <li>Utilize instrumentos apropriados para medir a tensão e a frequência de operação do motor.</li>\n            <li>Assegure-se de que os valores estão dentro das variações especificadas pela norma NEMA MG-1 Parte 12.</li>\n        </ul>\n    </li>\n</ol>\n\n<h3><strong>Conclusão:</strong></h3>\n<p>Após seguir todos os passos, registre qualquer anomalia encontrada e reporte ao supervisor imediatamente para ações corretivas. Assegure-se de que todas as ferramentas e equipamentos utilizados sejam devidamente armazenados após o uso.</p>\n\n<h3><strong>Nota:</strong></h3>\n<p>Este procedimento deve ser realizado com o motor desligado e em condições seguras para evitar acidentes.</p>`},
                ...
                {items.map(item => (
                    <div className="m-5 bg-white auto-h rounded-base p-3 text-black cursor-pointer hover:bg-gray-300" onClick={() => openOrder(item.id)}>  
                        ...
                        <div className="text-center pt-4 pr-4 font-bold text-white text-2xl">
                            <button className="rounded bg-green-700 p-2 hover:bg-green-800" onClick={(e) => deleteItem(item.id, e)}>Concluir</button>
                        </div>
